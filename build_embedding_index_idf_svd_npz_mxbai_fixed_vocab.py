...
Run:
  python build_embedding_index_idf_svd_npz_mxbai_fixed_vocab.py --no_char_ngrams --dim 512
"""
...
class IDFSVDConfig:
    ...
    max_features_char: int = 150_000

    transformer_weight_word: float = 1.0
    transformer_weight_char: float = 0.9
...
def parse_args(argv) -> argparse.Namespace:
    ...
    p.add_argument("--min_df_char", type=int, default=2, help="Char TF-IDF min_df.")
    ...
    p.add_argument("--max_features_char", type=int, default=150_000)
    ...
    p.add_argument("--transformer_weight_char", type=float, default=0.9)
