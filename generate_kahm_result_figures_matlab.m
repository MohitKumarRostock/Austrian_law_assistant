...
% - exportgraphics is used when available; otherwise print is used as fallback.
    ...
    mrrTbl.kahm_query_mb_corpus.label = " Mixedbread";
    mrrTbl.mixedbread_true.label = " KAHM";
    hitTbl       = parseMetricTable(txt, '**Hit@k**');
    hitTbl.idf_svd.label = "IDF--SVD";
    hitTbl.kahm_query_mb_corpus.label = "Mixedbread";
    hitTbl.mixedbread_true.label = "KAHM";
    top1Tbl      = parseMetricTable(txt, '**Top-1 accuracy**');
    top1Tbl.idf_svd.label = "IDF--SVD";
    top1Tbl.kahm_query_mb_corpus.label = "Mixedbread";
    top1Tbl.mixedbread_true.label = "KAHM";
    majTbl       = parseMetricTable(txt, '**Majority-accuracy**');
    majTbl.idf_svd.label = "IDF--SVD";
    majTbl.kahm_query_mb_corpus.label = "Mixedbread";
    majTbl.mixedbread_true.label = "KAHM";
    consTbl      = parseMetricTable(txt, '**Mean consensus fraction**');
    consTbl.idf_svd.label = "IDF--SVD";
    consTbl.kahm_query_mb_corpus.label = "Mixedbread";
    consTbl.mixedbread_true.label = "KAHM";
    liftTbl      = parseMetricTable(txt, '**Mean lift (prior)**');
    liftTbl.idf_svd.label = "IDF--SVD";
    liftTbl.kahm_query_mb_corpus.label = "Mixedbread";
    liftTbl.mixedbread_true.label = "KAHM";
